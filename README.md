...
Expect every new release to invalidate at least some of your old save files. Pretty much nothing can be done about this, as saves are function offset based, and those offsets change almost every time the engine binary changes.
