...
extern ui_enginefuncs_t g_ui_engfuncs;
extern ui_textfuncs_t g_ui_textfuncs;
...
extern ui_globalvars_t		*ui_gpGlobals;
...
#define ScreenHeight	(ui_gpGlobals->scrHeight)
// ScreenWidth returns the width of the screen, in pixels
#define ScreenWidth		(ui_gpGlobals->scrWidth)
