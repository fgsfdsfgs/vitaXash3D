...
static void UI_PlayerSetup_Ownerdraw( void *self )
{
	...
	else
	{
		...
		uiPlayerSetup.refdef.time = ui_gpGlobals->time;
		uiPlayerSetup.refdef.frametime = ui_gpGlobals->frametime;
...
static void UI_PlayerSetup_Init( void )
{
	...
	uiPlayerSetup.ent->curstate.animtime = ui_gpGlobals->time;	// start animation
